    ...
    >
      ...
      {size && (
        <motion.div
          ...
          className={cn(
            "absolute bottom-0 left-1/2 -translate-x-1/2 overflow-hidden border border-hit/35 bg-panel/95 text-bone shadow-[0_8px_32px_rgba(0,0,0,0.45),0_0_0_1px_rgba(107,163,255,0.12)] backdrop-blur-md",
            squircle
          )}
          initial={false}
          animate={{
