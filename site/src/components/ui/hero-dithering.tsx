...
export function HeroDitheringContainer({
  ...
  return (
    <div
      className={cn(
        "relative z-10 mx-auto grid max-w-[1200px] gap-6 pb-6 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] md:items-start md:gap-6 md:pb-8 lg:gap-6",
        className
      )}
...
export function HeroDitheringContent({
  ...
  return (
    <div
      className={cn(
        "flex flex-col justify-center gap-3 text-balance sm:gap-3.5 md:gap-4 md:pr-2 lg:pr-4",
        className
      )}
...
export function HeroDitheringHeading({
  ...
  return (
    <div
      className={cn("pt-4 text-center sm:pt-6 md:pt-0 md:text-left", className)}
    ...
    >
      {children ?? (
        <div className="relative">
          <h2
            className={cn(
              "font-pixel-circle relative mb-0 text-3xl tracking-wide text-balance sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-6xl",
              headingClassName
            )}
...
export function HeroDitheringDescription({
  ...
  return (
    <div
      className={cn(
        "mx-auto max-w-xl pb-2 text-center sm:pb-4 md:mx-0 md:max-w-none md:pb-0 md:text-left",
        className
      )}
    ...
    >
      {children ?? (
        <p
          className={cn(
            "text-muted mt-0 mb-0 max-w-[36ch] font-sans text-sm leading-relaxed sm:text-base md:max-w-[38ch]",
            descriptionClassName
          )}
...
export function HeroDitheringVisual({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto hidden aspect-square w-full md:block md:h-[min(58vh,560px)] md:-ml-6 lg:-ml-8",
        className
      )}
...
export function HeroDitheringMobileVisual({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute inset-x-0 -bottom-24 -z-10 h-[360px] overflow-hidden md:hidden",
        className
      )}
